...
Attach `AWSLambdaBasicExecutionRole`, `AWSXRayDaemonWriteAccess` and inline policy (Secrets Manager, S3, EventBridge, DynamoDB, SES, SQS, WebSocket).
...
Next: [5.5.2 Lambda Functions](../5.5.2-lambda-functions/).
